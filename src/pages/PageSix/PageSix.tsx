import { PageSixHeader } from './components/PageSixHeader'
import { PageSixHero } from './components/PageSixHero'
import { PageSixLatestStories } from './components/PageSixLatestStories'
...
export function PageSix() {
  return (
    <div className="min-h-screen bg-background text-text-primary">
      <PageSixHeader brandLabel="UNDERGROUND WAVES" links={navigationLinks} onNavigate={navigateTo} />
      <main>
        <PageSixHero {...heroContent} />
        <PageSixLatestStories
