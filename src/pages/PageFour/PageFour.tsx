import { PageFourHeader } from './components/PageFourHeader/PageFourHeader'
import { PageFourHero } from './components/PageFourHero/PageFourHero'
import { StoriesSection, type Story } from './components/StoriesSection/StoriesSection'
...
export function PageFour() {
  return (
    <div className={styles.page}>
      <PageFourHeader brandName="Underground Waves" navItems={NAV_ITEMS} />
