...
import { PageNineNavbar } from './components/PageNineNavbar'
import { PageNineHero } from './components/PageNineHero'
import { PageNineStories } from './components/PageNineStories'
...
export function PageNine() {
  return (
    <div className="min-h-screen bg-background text-text-primary">
      <PageNineNavbar brandLabel="UNDERGROUND WAVES" links={navigationLinks} onNavigate={navigateTo} />
      <main>
        <PageNineHero
