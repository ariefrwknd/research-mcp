...
export function PageNineStoryCard({
  imageUrl,
  category,
  readLength,
  title,
  ...
  ctaLabel,
  href,
}: PageNineStoryCardProps) {
  return (
    <article className="flex h-full w-full flex-col overflow-hidden border border-border bg-muted">
